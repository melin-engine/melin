...
echo ""
echo "  Server:  sudo target/release/trading-server --xdp-interface $VETH1 --bind 10.99.0.2:9876 --journal /tmp/xdp-test.journal --accounts 10 --instruments 2"
echo "  Bench:   target/release/trading-bench 10000 --udp --addr 10.99.0.2:9876 --warmup 1000 --accounts 10 --instruments 2"
echo ""
