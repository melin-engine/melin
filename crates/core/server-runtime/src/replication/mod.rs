    ...
    A::QueryResponse: Send + 'static,
{
    ...
    journal_stage.set_preparer_core(cores.journal_prep.core);
    journal_stage.set_staging_mode(staging_mode);
    journal_stage.set_disk_core(cores.journal_disk.core);
    journal_stage.set_disk_wait(cores.journal_disk.wait);
