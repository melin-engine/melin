...
use auth::authenticate_with_primary;
use protocol::{
    MAX_CONTROL_FRAME, MAX_DATA_FRAME, decode_primary_message, encode_ack, encode_handshake,
    read_frame,
};
...
mod tests {
    ...
    use super::protocol::{
        ...
        decode_replica_message, encode_auth_failed, encode_auth_ok, encode_challenge,
        encode_challenge_response, encode_data_batch, encode_hash_mismatch, encode_heartbeat,
